...
public class Cis265_poly_hw {
   ...
   endBlock();
    ...
    startBlock();
        write(String.format("this(%d,%d);", getUniqueInt(0,200), getUniqueInt(0,200)));
        line = String.format("other = %d;", getUniqueInt(0,200));
        write(line);
    endBlock();
    ...
    write("public String toString()");
    startBlock();
        write("return(String.format(\"(C %d %d %d)\", alpha, beta, other));");
    endBlock();
endBlock();
        ...
        writer.close();
           ...
           line = "//value of: arr[0].alpha: ____ arr[0].beta: ___ arr[0].other: ___";
           write(line);

           line = "//value of: arr[1].alpha: ____ arr[1].beta: ___ arr[1].other: ___";
           write(line);
           line = "//value of: arr[2].alpha: ____ arr[2].beta: ___ arr[2].other: ___";
           write(line);
